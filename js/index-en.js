...
alert("Dear EPP holders,Thanks for your support along the way, EPP has received a lot of attention in a very short period of time since its launch, and caused a stir in the industry. However, due to the industry shock, EPP 1.0 failed to run more continuously.At present, EPP is urgently gathering all senior players to study the latest gameplay of EPP 2.0. Meanwhile, GOLD generated by EPP 1.0 will be inherited into EPP 2.0 and play a more important role. Please wait and see!If the player does not complete the redemption, the EPP pass will be sent to the betting address proportionally.")
