 ...
 var eppContract;
 //alert("各位EPP持有者：感谢各位一路以来的支持，EPP自上线以来在极短的时间内获得了极高的关注度，并一度行业造成轰动性的影响，但由于造成了行业震动，使EPP 1.0没能更加持续地运行下去。目前，EPP正在紧急召集各路资深玩家，一起研究EPP 2.0的最新玩法，同时EPP 1.0产生的GOLD将继承到EPP 2.0中并发挥更重要的作用，请各位玩家拭目以待！未完成赎回的玩家，EPP通证将按比例发送到投注地址。")
